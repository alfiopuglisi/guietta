...
+---------------------+---------------------------------------+-------------+
| MA('name')          |   Matplotlib FigureCanvas with        |             |
...
+---------------------+---------------------------------------+-------------+
| HB('a.png', 'b.png')|   Special heart beat widget, a and b  | 'a'         |
|                     |   may be two different images or texts|             |
+---------------------+---------------------------------------+-------------+
| HValueSlider('name')|   Horizontal slider + edit combination|             |
+---------------------+---------------------------------------+-------------+
| VValueSlider('name')|   Vertical slider + edit combination  |             |
+---------------------+---------------------------------------+-------------+
